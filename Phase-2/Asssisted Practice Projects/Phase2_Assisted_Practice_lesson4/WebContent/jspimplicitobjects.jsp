...
%>
<a href="jspimplicitobjects.jsp?office=head_office">Show usage of response object</a><br>
<a href="jspimplicitobjects.jsp?error=1">Show usage of error  object</a><br>
